    ...
    $('#pageMain').append($('<div class="modal fade" id="modalResponse" tabindex="-1" aria-labelledby="modalResponse" aria-hidden="true">')
        .append($('<div class="modal-dialog">')
            .append($('<div  class="modal-content">')
                ...
                .append($('<div style="background-color: #6DC7F6;" class="modal-footer">').append('<button type="button" style="background-color: #313436;" class="btn btn-primary" data-bs-dismiss="modal">Ok</button>'))))
    )
